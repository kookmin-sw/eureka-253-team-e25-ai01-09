...
3. 인공지능학과는 대학원 진학이 필수인가요?  
  AI분야는 현재 새로운 지식이 쏟아지고 있다. 학과에서는 60~70년대에 만들어진 자료구조, 알고리즘을 여전히 배우지만 LLM의 핵심 기술은 2017년에 등장했다. 이러한 점들 때문에 계속 새롭게 변화하는 인공지능에선 대학원이 필수라고 얘기가 나오는 것.  
...
6. 대학원에 진학하기 전에 준비하면 좋은 것들은 무엇이 있나요?  
  학과공부 열심히 하기. 벼락치기는 남는게 없다. 배우는 내용을 정말로 이해하는게 중요함.  
  검증된 논문을 읽어보면서, 모르는 부분을 채워가는 과정을 통해 공부해나가면 된다.  
