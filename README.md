...
| **이름** | **전공** | **관심사** |
| --- | --- | --- |
| **김현구** | 인공지능전공 | 인공지능, 보안, 데이터베이스 |
| **박재민** | 인공지능전공 | 인공지능, 프론트엔드, 백엔드 |
| **유현민** | 인공지능전공 | 해외인턴, 인공지능, 스타트업, 빅데이터 |
| **최예은** | 인공지능전공 | 인공지능, UX/UI |
| **한유진** | 인공지능전공 | 인공지능, 모바일 앱 |
...
(겉으로는 조용하지만, 우리는 완전하게 끝까지 해내고, 그 결과는 오래 남는다. 그리고 이번 팀플을 통해 우리는 한계라는 담을 뛰어 넘는다.)
